return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader><C-h>", function() harpoon:list():replace_at(1) end, { desc = "Replace first element" })
    vim.keymap.set("n", "<leader><C-t>", function() harpoon:list():replace_at(2) end, { desc = "Replace second element" })
    vim.keymap.set("n", "<leader><C-n>", function() harpoon:list():replace_at(3) end, { desc = "Replace third element" })
    vim.keymap.set("n", "<leader><C-s>", function() harpoon:list():replace_at(4) end, { desc = "Replace fourth element" })
